...
#define MessageTimer_CY_TCPWM_V2                    (CYIPBLOCK_m0s8tcpwm_VERSION == 2u)
#define MessageTimer_CY_TCPWM_4000                  (CY_PSOC4_4000)
...
/* Timer/Counter Mode */
#define MessageTimer_TC_PERIOD_VALUE                (20lu)
...
/* Trigger modes */
#define MessageTimer_TRIG_RISING                    ((uint32)MessageTimer__TRIG_RISING)
#define MessageTimer_TRIG_FALLING                   ((uint32)MessageTimer__TRIG_FALLING)
#define MessageTimer_TRIG_BOTH                      ((uint32)MessageTimer__TRIG_BOTH)
#define MessageTimer_TRIG_LEVEL                     ((uint32)MessageTimer__TRIG_LEVEL)

/* Interrupt mask */
#define MessageTimer_INTR_MASK_TC                   ((uint32)MessageTimer__INTR_MASK_TC)
#define MessageTimer_INTR_MASK_CC_MATCH             ((uint32)MessageTimer__INTR_MASK_CC_MATCH)
...
#define MessageTimer_PWM_MODE_ASYM                  (MessageTimer_CC_MATCH_INVERT       |   \
                                                         MessageTimer_OVERLOW_SET           |   \
                                                         MessageTimer_UNDERFLOW_CLEAR)

#if (MessageTimer_CY_TCPWM_V2)
    #if(MessageTimer_CY_TCPWM_4000)
        ...
        #define MessageTimer_PWM_MODE_CENTER                (MessageTimer_CC_MATCH_INVERT       |   \
                                                                 MessageTimer_OVERLOW_SET           |   \
                                                                 MessageTimer_UNDERFLOW_CLEAR)
    #endif /* (MessageTimer_CY_TCPWM_4000) */
#else
    #define MessageTimer_PWM_MODE_CENTER                (MessageTimer_CC_MATCH_INVERT       |   \
                                                             MessageTimer_OVERLOW_NO_CHANGE     |   \
                                                             MessageTimer_UNDERFLOW_CLEAR)
#endif /* (MessageTimer_CY_TCPWM_NEW) */
...
#define MessageTimer_QUAD_SIGNALS_MODES                                                             \
...
#define MessageTimer_PWM_SIGNALS_MODES                                                              \
...
#define MessageTimer_TIMER_SIGNALS_MODES                                                            \
...
#define MessageTimer_TIMER_UPDOWN_CNT_USED                                                          \
                ((MessageTimer__COUNT_UPDOWN0 == MessageTimer_TC_COUNTER_MODE)                  ||\
                 (MessageTimer__COUNT_UPDOWN1 == MessageTimer_TC_COUNTER_MODE))

#define MessageTimer_PWM_UPDOWN_CNT_USED                                                            \
                ((MessageTimer__CENTER == MessageTimer_PWM_ALIGN)                               ||\
                 (MessageTimer__ASYMMETRIC == MessageTimer_PWM_ALIGN))               
        
#define MessageTimer_PWM_PR_INIT_VALUE              (1u)
#define MessageTimer_QUAD_PERIOD_INIT_VALUE         (0x8000u)
