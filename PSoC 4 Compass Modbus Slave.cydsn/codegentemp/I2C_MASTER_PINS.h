...
/* Unconfigured pins */
#define I2C_MASTER_REMOVE_MOSI_SCL_RX_WAKE_PIN    (1u)
#define I2C_MASTER_REMOVE_MOSI_SCL_RX_PIN         (1u)
#define I2C_MASTER_REMOVE_MISO_SDA_TX_PIN         (1u)
...
/* Unconfigured pins */
#define I2C_MASTER_MOSI_SCL_RX_WAKE_PIN   (0u == I2C_MASTER_REMOVE_MOSI_SCL_RX_WAKE_PIN)
#define I2C_MASTER_MOSI_SCL_RX_PIN        (0u == I2C_MASTER_REMOVE_MOSI_SCL_RX_PIN)
#define I2C_MASTER_MISO_SDA_TX_PIN        (0u == I2C_MASTER_REMOVE_MISO_SDA_TX_PIN)
...
****************************************/
    ...
    #include "I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake.h"
#endif /* (I2C_MASTER_MOSI_SCL_RX_WAKE_PIN) */

#if(I2C_MASTER_MOSI_SCL_RX_PIN)
    #include "I2C_MASTER_spi_mosi_i2c_scl_uart_rx.h"
#endif /* (I2C_MASTER_MOSI_SCL_RX_PIN) */

#if(I2C_MASTER_MISO_SDA_TX_PIN)
    #include "I2C_MASTER_spi_miso_i2c_sda_uart_tx.h"
...
#if(I2C_MASTER_MOSI_SCL_RX_WAKE_PIN)
    #define I2C_MASTER_MOSI_SCL_RX_WAKE_HSIOM_REG  \
                                                (*(reg32 *) I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM)
    #define I2C_MASTER_MOSI_SCL_RX_WAKE_HSIOM_PTR  \
                                                ( (reg32 *) I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM)
    #define I2C_MASTER_MOSI_SCL_RX_WAKE_HSIOM_MASK \
                                                (I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM_MASK)
    #define I2C_MASTER_MOSI_SCL_RX_WAKE_HSIOM_POS  \
                                                (I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM_SHIFT)

    #define I2C_MASTER_MOSI_SCL_RX_WAKE_INTCFG_REG    (*(reg32 *) \
                                                              I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake__0__INTCFG)
    #define I2C_MASTER_MOSI_SCL_RX_WAKE_INTCFG_PTR    ( (reg32 *) \
                                                              I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake__0__INTCFG)

    #define I2C_MASTER_INTCFG_TYPE_MASK                  (0x03u)
    #define I2C_MASTER_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS  (I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake__SHIFT)
    #define I2C_MASTER_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK ((uint32)                                           \
                                                                    ((uint32) I2C_MASTER_INTCFG_TYPE_MASK << \
                                                                    I2C_MASTER_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS))
#endif /* (I2C_MASTER_MOSI_SCL_RX_WAKE_PIN) */

#if(I2C_MASTER_MOSI_SCL_RX_PIN)
    #define I2C_MASTER_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) I2C_MASTER_spi_mosi_i2c_scl_uart_rx__0__HSIOM)
    #define I2C_MASTER_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) I2C_MASTER_spi_mosi_i2c_scl_uart_rx__0__HSIOM)
    #define I2C_MASTER_MOSI_SCL_RX_HSIOM_MASK     (I2C_MASTER_spi_mosi_i2c_scl_uart_rx__0__HSIOM_MASK)
    #define I2C_MASTER_MOSI_SCL_RX_HSIOM_POS      (I2C_MASTER_spi_mosi_i2c_scl_uart_rx__0__HSIOM_SHIFT)
#endif /* (I2C_MASTER_MOSI_SCL_RX_PIN) */

#if(I2C_MASTER_MISO_SDA_TX_PIN)
    #define I2C_MASTER_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) I2C_MASTER_spi_miso_i2c_sda_uart_tx__0__HSIOM)
    #define I2C_MASTER_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) I2C_MASTER_spi_miso_i2c_sda_uart_tx__0__HSIOM)
    #define I2C_MASTER_MISO_SDA_TX_HSIOM_MASK     (I2C_MASTER_spi_miso_i2c_sda_uart_tx__0__HSIOM_MASK)
    #define I2C_MASTER_MISO_SDA_TX_HSIOM_POS      (I2C_MASTER_spi_miso_i2c_sda_uart_tx__0__HSIOM_SHIFT)
#endif /* (I2C_MASTER_MISO_SDA_TX_PIN_PIN) */
...
#define I2C_MASTER_MOSI_SCL_RX_PIN_INDEX      (0u) /* RX pins without interrupt */
#define I2C_MASTER_MOSI_SCL_RX_WAKE_PIN_INDEX (0u) /* RX pin with interrupt     */
#define I2C_MASTER_MISO_SDA_TX_PIN_INDEX      (1u)
...
#define I2C_MASTER_MOSI_SCL_RX_PIN_MASK      ((uint32) 0x01u << I2C_MASTER_MOSI_SCL_RX_PIN_INDEX)
#define I2C_MASTER_MOSI_SCL_RX_WAKE_PIN_MASK ((uint32) 0x01u << I2C_MASTER_MOSI_SCL_RX_WAKE_PIN_INDEX)
#define I2C_MASTER_MISO_SDA_TX_PIN_MASK      ((uint32) 0x01u << I2C_MASTER_MISO_SDA_TX_PIN_INDEX)
...
/* Unconfigured SCB: scl signal */
#elif(I2C_MASTER_MOSI_SCL_RX_WAKE_PIN)
    #define I2C_MASTER_SET_I2C_SCL_DR(val) \
                            I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake_Write(val)
    ...
    #define I2C_MASTER_WAIT_SCL_SET_HIGH  (0u == I2C_MASTER_spi_mosi_i2c_scl_uart_rx_wake_Read())

#elif(I2C_MASTER_MOSI_SCL_RX_PIN)
    #define I2C_MASTER_SET_I2C_SCL_DR(val) \
                            I2C_MASTER_spi_mosi_i2c_scl_uart_rx_Write(val)
    ...
    #define I2C_MASTER_WAIT_SCL_SET_HIGH  (0u == I2C_MASTER_spi_mosi_i2c_scl_uart_rx_Read())
...
#elif(I2C_MASTER_MISO_SDA_TX_PIN)
    #define I2C_MASTER_WAIT_SDA_SET_HIGH  (0u == I2C_MASTER_spi_miso_i2c_sda_uart_tx_Read())
