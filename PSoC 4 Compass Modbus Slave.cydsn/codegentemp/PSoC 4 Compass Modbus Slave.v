...
module SCB_P4_v2_0_3 (
	...
	cy_psoc3_pins_v1_10
		#(.id("687cf13a-68e7-4784-b555-0d76586c4819/5382e105-1382-4a2e-b9f4-3bb2feba71e0"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("687cf13a-68e7-4784-b555-0d76586c4819/22863ebe-a37b-476f-b252-6e49a8c00b12"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
    ...
    Timer_v2_70_2 SpeedTimer (
        .reset(Net_12),
        .interrupt(Net_356),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_1644),
        .tc(Net_1645),
        .clock(Net_10));
    defparam SpeedTimer.CaptureCount = 2;
    defparam SpeedTimer.CaptureCounterEnabled = 0;
    defparam SpeedTimer.DeviceFamily = "PSoC4";
    defparam SpeedTimer.InterruptOnCapture = 0;
    defparam SpeedTimer.InterruptOnTC = 1;
    defparam SpeedTimer.Resolution = 8;
    defparam SpeedTimer.SiliconRevision = "17";
